...
Cause: stale Outlook profile after migration. 
Action: recreated profile, confirmed mail flow. Preventive: added to migration checklist. User confirmed working.

Example 2
Raw ticket: “cant access sharepoint or teams files, laptop is new”
Closure note:Resolved:
Cause: device had not checked in to Intune.
Action: forced sync, policy applied, compliance green. User confirmed access.
